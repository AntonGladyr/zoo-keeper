																		...
																		, AsyncCallback.ChildrenCallback
{
	...
	void getTasks()
	{
		zk.getChildren("/dist93/tasks", this, this, null);  
	}
	...
	void runForMaster() throws UnknownHostException, KeeperException, InterruptedException
	{
		...
		zk.create("/dist93/master", pinfo.getBytes(), Ids.OPEN_ACL_UNSAFE, CreateMode.EPHEMERAL);
	}
	...
	public void process(WatchedEvent e)
	{
		...
		if(e.getType() == Watcher.Event.EventType.NodeChildrenChanged && e.getPath().equals("/dist93/tasks"))
		{
	...
	public void processResult(int rc, String path, Object ctx, List<String> children)
	{
		...
		for(String c: children)
		{
			...
			try
			{
				...
				byte[] taskSerial = zk.getData("/dist93/tasks/"+c, false, null);
